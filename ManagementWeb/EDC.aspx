<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EDC.aspx.cs" Inherits="EDC.Data.EDC" %>
...
<body>
    ...
    <div>
        ...
        <table border="1" cellpadding="0" cellspacing="0" style="width: 750px; border-collapse: collapse">
            <tr>
                <td align="center">
                    <span style="color: #ff0000">*</span>EDC編號
                </td>
                <td>
                    <asp:TextBox ID="tbxEDCNO" runat="server" Width="200px" MaxLength="50"></asp:TextBox>
                </td>
                <td align="center">
                    <span style="color: #ff0000">*</span>EDC IP位址
                </td>
                <td>
                    <asp:TextBox ID="tbxEDCIP" runat="server" Width="200px" MaxLength="50"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="center">
                    <span style="color: #ff0000">*</span>EDC 目前狀態
                </td>
                <td colspan="3">
            ...
            <tr>
                <td align="center">
                    <span style="color: #ff0000">*</span>使用時間(秒)
                </td>
                <td>
                    <asp:TextBox ID="tbxEDCLimitTime" runat="server" Width="50px" MaxLength="5"></asp:TextBox>
                </td>
                <td align="center">
                    <span style="color: #ff0000">*</span>是否顯示使用時間
                </td>
                <td>
                    <asp:TextBox ID="tbxEDCShowLimitTime" runat="server" Width="200px" MaxLength="50"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="center">
                    <span style="color: #ff0000">*</span>事務機IP
                </td>
                <td>
                    <asp:TextBox ID="TextBox2" runat="server" Width="50px" MaxLength="2"></asp:TextBox>
                </td>
                <td align="center">
                    <span style="color: #ff0000">*</span>事務機目前狀態
                </td>
                <td>
