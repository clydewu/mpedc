<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Level.aspx.cs" Inherits="EDC.Data.Level" %>
...
<body>
    ...
    <div>
        ...
        <table border="1" cellpadding="0" cellspacing="0" style="width: 750px; border-collapse: collapse">
            <tr>
                <td align="center">
                    <span style="color: #ff0000">*</span>層級初始額度
                ...
                <td align="center">
                    <span style="color: #ff0000">*</span>是否為預設值
                </td>
                <td>
